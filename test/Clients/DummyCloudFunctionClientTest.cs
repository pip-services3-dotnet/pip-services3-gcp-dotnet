...
namespace PipServices3.Gcp.Clients
{
    ...
    public class DummyCloudFunctionClientTest : IDisposable
    {
        protected DummyCloudFunctionClient client;
        protected DummyClientFixture fixture;
        public DummyCloudFunctionClientTest()
        {
            ...
            fixture.StartCloudServiceLocally("PipServices3.Gcp.Services.Function");
        }
